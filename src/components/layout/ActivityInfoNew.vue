<template>
    <Form class="activity-info-form" ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="120">
        <h3 class="activity-info-title">新增活動資訊</h3>

        <div class="sign-up-box">
            <FormItem label="報名開始日期" prop="startDate">
                <Input style="width: 140px;" v-model="formValidate.startDate"></Input>
            </FormItem>
        ...
        <FormItem label="活動日期" prop="actDate">
            <Input style="width: 400px;" v-model="formValidate.actDate"></Input>
        </FormItem>
        <FormItem label="場次時間" prop="sessTime">
        ...
        <FormItem label="報名人數" prop="memNum">
...
export default {
    ...
    methods: {
        ...
        cancel() {
            const activityInfoBox = document.getElementById('activity-new');
